...
try
    ...
    for blockIDx=startBlockIdx:numBlocks
        ...
        fprintf("stimOri \t stimDur \t stimSpread \t stimContrast \t reportedOri \t reportedConf \t rawOriError \t trlError")
        ...
        % while nCompletedTrialsCurrBlock < 10
            ...
            % Show reward screen
            if rewardPoints <= 0
                DrawFormattedText(psychToolBoxConfig.w,['-' num2str(abs(rewardPoints),'%d')],'center', ...
            ...
            DrawFormattedText(psychToolBoxConfig.w, ['' num2str(currentTotalRewardPoints, '%d')], ...
                'center', psychToolBoxConfig.yCenter + 30, [0 0 0]);
            Screen('Flip', psychToolBoxConfig.w);
