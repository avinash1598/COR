...
stimSpread = [5, 30];                                                       % Stimulus spread in degrees
...
try
    ...
    for blockIDx=1:numBlocks
        ...
        for trialIDx=1:nTrialsPerBlock
            ...
            stimParam = drawStimuli(stimCfg_, trlCfg, psychToolBoxConfig);
            ...
            fixationHeld = checkFixation(eyeUsed, fixationWinCfg.fixThreshold, ...
            ...
            for iF = 1:length(stimParam.movietex)
                ...
                %     [], stimParam.movieRect, trlCfg.stimOri - oriRefStim);
                % Rotate by sample angle instead. Makes life much easier.
                % Screen('DrawTextures', psychToolBoxConfig.w, stimParam.movietex(iF), ...
                %     [], stimParam.movieRect, stimMetrics.meanAngle - trlCfg.stimOri); % This difference is super important - 0 degrees by default is vertical stimuli
                Screen('DrawTextures', psychToolBoxConfig.w, stimParam.movietex(iF), ...
...
%% Check fixation 
function fixationHeld = checkFixation(eyeUsed, fixThreshold, tStart, durFix, xCenter, yCenter, quitKey, checkFixationMaxDur)
fixationHeld = true;
